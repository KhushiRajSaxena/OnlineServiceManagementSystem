...
// For the first-time login request or when login fails, display the login form
?>
  ...
  <div class="container-fluid mb-5">
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="shadow-lg p-4" method="POST"> <!-- Set action to the current script -->
